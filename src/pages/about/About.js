        ...
        <Col className="text-center">
          ...
          <i class="fa-sharp fa-solid fa-note-sticky"></i>
            ...
            <p className="text-left">
              Yakker serves as a social media platform where you can post about
              anything you wish! Think of this website as Twitter, but with yaks
              instead. Sign up with a new account (no email address required for
              ...
              (reyakk) other user's posts, make comments, follow other users,
              and reyakk comments! You can keep track of posts you reyakked to
              in the "Reyakked" link in the navigation bar. Once you start
